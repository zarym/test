...
<html lang="en">
  ...
  <meta name="request-id" content="97E2:76BB:A31B7B:138774E:5C2A8B2B" data-pjax-transient>
  ...
  <meta name="octolytics-host" content="collector.githubapp.com" /><meta name="octolytics-app-id" content="github" /><meta name="octolytics-event-url" content="https://collector.githubapp.com/github-external/browser_event" /><meta name="octolytics-dimension-request_id" content="97E2:76BB:A31B7B:138774E:5C2A8B2B" /><meta name="octolytics-dimension-region_edge" content="iad" /><meta name="octolytics-dimension-region_render" content="iad" />
...
<meta class="js-ga-set" name="dimension1" content="Logged Out">
    ...
    <meta name="js-proxy-site-detection-payload" content="">

    <meta name="enabled-features" content="DASHBOARD_V2_LAYOUT_OPT_IN,EXPLORE_DISCOVER_REPOSITORIES,UNIVERSE_BANNER,MARKETPLACE_PLAN_RESTRICTION_EDITOR">

  <meta name="html-safe-nonce" content="1d135b74a682efa0ca9c5263dfd4a453b0ae7303">
  ...
  <meta name="octolytics-dimension-user_id" content="2465527" /><meta name="octolytics-dimension-user_login" content="analogdevicesinc" /><meta name="octolytics-dimension-repository_id" content="66658337" /><meta name="octolytics-dimension-repository_nwo" content="analogdevicesinc/buildroot" /><meta name="octolytics-dimension-repository_public" content="true" /><meta name="octolytics-dimension-repository_is_fork" content="false" /><meta name="octolytics-dimension-repository_network_root_id" content="66658337" /><meta name="octolytics-dimension-repository_network_root_nwo" content="analogdevicesinc/buildroot" /><meta name="octolytics-dimension-repository_explore_github_marketplace_ci_cta_shown" content="false" />
    ...
    <link rel="canonical" href="https://github.com/analogdevicesinc/buildroot/blob/pluto/board/pluto/ifupdown.sh" data-pjax-transient>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" data-scope-type="Repository" data-scope-id="66658337" data-scoped-search-url="/analogdevicesinc/buildroot/search" data-unscoped-search-url="/search" action="/analogdevicesinc/buildroot/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
      <label class="form-control header-search-wrapper header-search-wrapper-jump-to position-relative d-flex flex-justify-between flex-items-center js-chromeless-input-container">
        <input type="text"
          ...
          aria-label="Search"
          data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations#csrf-token=ZMOQ+EInOHj+by0eZXT4kHVWjkBqpjMegisK60T+GkdTldbEbh/BjKuFRXgXdxiveo13PdJcKzGP4hNk8vLGAA=="
          spellcheck="false"
          autocomplete="off"
          >
  ...
  <a tabindex="-1" class="no-underline d-flex flex-auto flex-items-center jump-to-suggestions-path js-jump-to-suggestion-path js-navigation-open p-2" href="">
    ...
    <div aria-hidden="true" class="border rounded-1 flex-shrink-0 bg-gray px-1 text-gray-light ml-1 f6 d-none d-on-nav-focus js-jump-to-badge-jump">
      ...
      <span class="d-inline-block ml-1 v-align-middle">↵</span>
        ...
        <a class="HeaderMenu-link no-underline mr-3" href="/login?return_to=%2Fanalogdevicesinc%2Fbuildroot%2Fblob%2Fpluto%2Fboard%2Fpluto%2Fifupdown.sh" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign&nbsp;in</a>
...
<div class="container new-discussion-timeline experiment-repo-nav  ">
  <div class="repository-content ">
    ...
    <a class="d-none js-permalink-shortcut" data-hotkey="y" href="/analogdevicesinc/buildroot/blob/fea212afc7dc0ee530762a1921d9ae8180778ffa/board/pluto/ifupdown.sh">Permalink</a>

    <!-- blob contrib key: blob_contributors:v21:059aa7d9ac722d67e5025094c39e31f2 -->

        <div class="signup-prompt-bg rounded-1">
      <div class="signup-prompt p-4 text-center mb-4 rounded-1">
        <div class="position-relative">
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form action="/site/dismiss_signup_prompt" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="B8GIcMAb1LUGMK3i+pyINdd6hVtMO4NR6ZQom2sTIxYCucsuHBtqtuqYjN4O2J4kUwRDRv9oUtxeOSt0OIoVbA==" />
...
<div class="select-menu-list" role="tabpanel">
  <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
      <a class="select-menu-item js-navigation-item js-navigation-open "
         href="/analogdevicesinc/buildroot/blob/index-html-update/board/pluto/ifupdown.sh"
      ...
      <a class="select-menu-item js-navigation-item js-navigation-open "
         href="/analogdevicesinc/buildroot/blob/master/board/pluto/ifupdown.sh"
         data-name="master"
         data-skip-pjax="true"
         rel="nofollow">
        <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
      ...
      <a class="select-menu-item js-navigation-item js-navigation-open selected"
         href="/analogdevicesinc/buildroot/blob/pluto/board/pluto/ifupdown.sh"
         data-name="pluto"
         data-skip-pjax="true"
         rel="nofollow">
        <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
      ...
      <a class="select-menu-item js-navigation-item js-navigation-open "
         href="/analogdevicesinc/buildroot/blob/rgetz-html-updates/board/pluto/ifupdown.sh"
      ...
      <a class="select-menu-item js-navigation-item js-navigation-open "
         href="/analogdevicesinc/buildroot/blob/rgetz-patch-1/board/pluto/ifupdown.sh"
      ...
      <a class="select-menu-item js-navigation-item js-navigation-open "
         href="/analogdevicesinc/buildroot/blob/rgetz-patch-2/board/pluto/ifupdown.sh"
      ...
      <a class="select-menu-item js-navigation-item js-navigation-open "
         href="/analogdevicesinc/buildroot/blob/rgetz-patch-3/board/pluto/ifupdown.sh"
...
<div class="select-menu-list" role="tabpanel" hidden>
  <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
      <a class="select-menu-item js-navigation-item js-navigation-open "
        href="/analogdevicesinc/buildroot/blob/v0.20/board/pluto/ifupdown.sh"
        data-name="v0.20"
        data-skip-pjax="true"
        rel="nofollow">
        <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
      ...
      <a class="select-menu-item js-navigation-item js-navigation-open "
        href="/analogdevicesinc/buildroot/blob/v0.1/board/pluto/ifupdown.sh"
        data-name="v0.1"
        data-skip-pjax="true"
        rel="nofollow">
        <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
  ...
  <div class="commit-tease">
      <span class="float-right">
        <a class="commit-tease-sha" href="/analogdevicesinc/buildroot/commit/7150def86330cb7392d0e668cff1bd9d74a2ef95" data-pjax>
          7150def
        </a>
        <relative-time datetime="2017-03-03T15:59:39Z">Mar 3, 2017</relative-time>
      </span>
      <div>
        ...
        <a class="user-mention" rel="contributor" data-hovercard-type="user" data-hovercard-url="/hovercards?user_id=1142945" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/mhennerich">mhennerich</a>
          <a data-pjax="true" title="board/pluto/ifupdown.sh: Pre-up interface


Signed-off-by: Michael Hennerich &lt;michael.hennerich@analog.com&gt;" class="message" href="/analogdevicesinc/buildroot/commit/7150def86330cb7392d0e668cff1bd9d74a2ef95">board/pluto/ifupdown.sh: Pre-up interface</a>
      </div>
...
<div class="file-header">
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      <a id="raw-url" class="btn btn-sm BtnGroup-item" href="/analogdevicesinc/buildroot/raw/pluto/board/pluto/ifupdown.sh">Raw</a>
        <a class="btn btn-sm js-update-url-with-hash BtnGroup-item" data-hotkey="b" href="/analogdevicesinc/buildroot/blame/pluto/board/pluto/ifupdown.sh">Blame</a>
      <a rel="nofollow" class="btn btn-sm BtnGroup-item" href="/analogdevicesinc/buildroot/commits/pluto/board/pluto/ifupdown.sh">History</a>
    </div>
...
<table class="highlight tab-size js-file-line-container" data-tab-size="8">
      ...
      <tr>
        ...
        <td id="LC3" class="blob-code blob-code-inner js-file-line"><span class="pl-k">case</span> <span class="pl-s"><span class="pl-pds">&quot;</span><span class="pl-smi">${ACTION}</span><span class="pl-pds">&quot;</span></span> <span class="pl-k">in</span></td>
      </tr>
      <tr>
        <td id="L4" class="blob-num js-line-number" data-line-number="4"></td>
        <td id="LC4" class="blob-code blob-code-inner js-file-line">add|<span class="pl-s"><span class="pl-pds">&quot;</span><span class="pl-pds">&quot;</span></span>)</td>
      </tr>
      <tr>
        <td id="L5" class="blob-num js-line-number" data-line-number="5"></td>
        <td id="LC5" class="blob-code blob-code-inner js-file-line">	ifconfig <span class="pl-smi">${MDEV}</span> up</td>
      </tr>
      <tr>
        <td id="L6" class="blob-num js-line-number" data-line-number="6"></td>
        <td id="LC6" class="blob-code blob-code-inner js-file-line">	ifup <span class="pl-smi">${MDEV}</span></td>
      </tr>
      <tr>
        <td id="L7" class="blob-num js-line-number" data-line-number="7"></td>
        <td id="LC7" class="blob-code blob-code-inner js-file-line">	<span class="pl-c1">echo</span> <span class="pl-s"><span class="pl-pds">$(</span>ip -f inet -o addr show <span class="pl-smi">${MDEV}</span><span class="pl-k">|</span>cut -d<span class="pl-cce">\ </span> -f 7 <span class="pl-k">|</span> cut -d/ -f 1<span class="pl-pds">)</span></span> <span class="pl-k">&gt;</span> /opt/ipaddr-<span class="pl-smi">${MDEV}</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC9" class="blob-code blob-code-inner js-file-line">remove)</td>
      </tr>
      <tr>
        <td id="L10" class="blob-num js-line-number" data-line-number="10"></td>
        <td id="LC10" class="blob-code blob-code-inner js-file-line">	ifdown <span class="pl-smi">${MDEV}</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC12" class="blob-code blob-code-inner js-file-line"><span class="pl-k">esac</span></td>
      </tr>
</table>
  ...
  <details class="details-reset details-overlay BlobToolbar position-absolute js-file-line-actions dropdown d-none" aria-hidden="true">
    ...
    <details-menu>
      <ul class="BlobToolbar-dropdown dropdown-menu dropdown-menu-se mt-2">
        ...
        <li><a class="dropdown-item js-update-url-with-hash" id="js-view-git-blame" role="menuitem" href="/analogdevicesinc/buildroot/blame/fea212afc7dc0ee530762a1921d9ae8180778ffa/board/pluto/ifupdown.sh">View git blame</a></li>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between pt-6 pb-2 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2018 <span title="0.21696s from unicorn-6d67c7dd56-mjlsd">GitHub</span>, Inc.</li>
