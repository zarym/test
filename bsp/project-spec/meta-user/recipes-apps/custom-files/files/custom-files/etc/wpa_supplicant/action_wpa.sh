...
<html lang="en">
  ...
  <title>buildroot/action_wpa.sh at pluto · analogdevicesinc/buildroot · GitHub</title>
  ...
  <meta name="request-id" content="8E64:76BA:9AEA62:11F6FF9:5C2A8B2C" data-pjax-transient>
...
<meta class="js-ga-set" name="dimension1" content="Logged Out">
    ...
    <meta name="js-proxy-site-detection-payload" content="">

    <meta name="enabled-features" content="DASHBOARD_V2_LAYOUT_OPT_IN,EXPLORE_DISCOVER_REPOSITORIES,UNIVERSE_BANNER,MARKETPLACE_PLAN_RESTRICTION_EDITOR">

  <meta name="html-safe-nonce" content="0e4a984313afa790b677fa4719da6706a9694eff">
  ...
  <meta name="octolytics-dimension-user_id" content="2465527" /><meta name="octolytics-dimension-user_login" content="analogdevicesinc" /><meta name="octolytics-dimension-repository_id" content="66658337" /><meta name="octolytics-dimension-repository_nwo" content="analogdevicesinc/buildroot" /><meta name="octolytics-dimension-repository_public" content="true" /><meta name="octolytics-dimension-repository_is_fork" content="false" /><meta name="octolytics-dimension-repository_network_root_id" content="66658337" /><meta name="octolytics-dimension-repository_network_root_nwo" content="analogdevicesinc/buildroot" /><meta name="octolytics-dimension-repository_explore_github_marketplace_ci_cta_shown" content="false" />
    ...
    <link rel="canonical" href="https://github.com/analogdevicesinc/buildroot/blob/pluto/board/pluto/wpa_supplicant/action_wpa.sh" data-pjax-transient>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" data-scope-type="Repository" data-scope-id="66658337" data-scoped-search-url="/analogdevicesinc/buildroot/search" data-unscoped-search-url="/search" action="/analogdevicesinc/buildroot/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
      <label class="form-control header-search-wrapper header-search-wrapper-jump-to position-relative d-flex flex-justify-between flex-items-center js-chromeless-input-container">
        <input type="text"
          ...
          aria-label="Search"
          data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations#csrf-token=cNCvjCwn/DCHIVXvtGWxxE2Bv548GAk6zAxH7xBmzDgp60xi3DNWVfpWqZZvCbEI8lxZUbTDjLY7kTM/MW8GEQ=="
          spellcheck="false"
          autocomplete="off"
          >
  ...
  <a tabindex="-1" class="no-underline d-flex flex-auto flex-items-center jump-to-suggestions-path js-jump-to-suggestion-path js-navigation-open p-2" href="">
    ...
    <div aria-hidden="true" class="border rounded-1 flex-shrink-0 bg-gray px-1 text-gray-light ml-1 f6 d-none d-on-nav-focus js-jump-to-badge-jump">
      ...
      <span class="d-inline-block ml-1 v-align-middle">↵</span>
        ...
        <a class="HeaderMenu-link no-underline mr-3" href="/login?return_to=%2Fanalogdevicesinc%2Fbuildroot%2Fblob%2Fpluto%2Fboard%2Fpluto%2Fwpa_supplicant%2Faction_wpa.sh" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign&nbsp;in</a>
...
<div class="container new-discussion-timeline experiment-repo-nav  ">
  <div class="repository-content ">
    ...
    <a class="d-none js-permalink-shortcut" data-hotkey="y" href="/analogdevicesinc/buildroot/blob/fea212afc7dc0ee530762a1921d9ae8180778ffa/board/pluto/wpa_supplicant/action_wpa.sh">Permalink</a>

    <!-- blob contrib key: blob_contributors:v21:74e85b256fae307d63d45456f63a8b43 -->

        <div class="signup-prompt-bg rounded-1">
      <div class="signup-prompt p-4 text-center mb-4 rounded-1">
        <div class="position-relative">
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form action="/site/dismiss_signup_prompt" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="TILmImygzpIwez1Sy4Jauac0AR8FsLxqR1dOKU9CbANEMpGgUAKHW/m1YP98ZoPWCoGDMBMohBkmmRsskvimAQ==" />
...
<div class="select-menu-list" role="tabpanel">
  <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
      <a class="select-menu-item js-navigation-item js-navigation-open "
         href="/analogdevicesinc/buildroot/blob/index-html-update/board/pluto/wpa_supplicant/action_wpa.sh"
      ...
      <a class="select-menu-item js-navigation-item js-navigation-open "
         href="/analogdevicesinc/buildroot/blob/master/board/pluto/wpa_supplicant/action_wpa.sh"
         data-name="master"
         data-skip-pjax="true"
         rel="nofollow">
        <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
      ...
      <a class="select-menu-item js-navigation-item js-navigation-open selected"
         href="/analogdevicesinc/buildroot/blob/pluto/board/pluto/wpa_supplicant/action_wpa.sh"
         data-name="pluto"
         data-skip-pjax="true"
         rel="nofollow">
        <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
      ...
      <a class="select-menu-item js-navigation-item js-navigation-open "
         href="/analogdevicesinc/buildroot/blob/rgetz-html-updates/board/pluto/wpa_supplicant/action_wpa.sh"
      ...
      <a class="select-menu-item js-navigation-item js-navigation-open "
         href="/analogdevicesinc/buildroot/blob/rgetz-patch-1/board/pluto/wpa_supplicant/action_wpa.sh"
      ...
      <a class="select-menu-item js-navigation-item js-navigation-open "
         href="/analogdevicesinc/buildroot/blob/rgetz-patch-2/board/pluto/wpa_supplicant/action_wpa.sh"
      ...
      <a class="select-menu-item js-navigation-item js-navigation-open "
         href="/analogdevicesinc/buildroot/blob/rgetz-patch-3/board/pluto/wpa_supplicant/action_wpa.sh"
...
<div class="select-menu-list" role="tabpanel" hidden>
  <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
      <a class="select-menu-item js-navigation-item js-navigation-open "
        href="/analogdevicesinc/buildroot/blob/v0.20/board/pluto/wpa_supplicant/action_wpa.sh"
        data-name="v0.20"
        data-skip-pjax="true"
        rel="nofollow">
        <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
      ...
      <a class="select-menu-item js-navigation-item js-navigation-open "
        href="/analogdevicesinc/buildroot/blob/v0.1/board/pluto/wpa_supplicant/action_wpa.sh"
        data-name="v0.1"
        data-skip-pjax="true"
        rel="nofollow">
        <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
...
<div class="file-header">
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      <a id="raw-url" class="btn btn-sm BtnGroup-item" href="/analogdevicesinc/buildroot/raw/pluto/board/pluto/wpa_supplicant/action_wpa.sh">Raw</a>
        <a class="btn btn-sm js-update-url-with-hash BtnGroup-item" data-hotkey="b" href="/analogdevicesinc/buildroot/blame/pluto/board/pluto/wpa_supplicant/action_wpa.sh">Blame</a>
      <a rel="nofollow" class="btn btn-sm BtnGroup-item" href="/analogdevicesinc/buildroot/commits/pluto/board/pluto/wpa_supplicant/action_wpa.sh">History</a>
    </div>
...
<table class="highlight tab-size js-file-line-container" data-tab-size="8">
      ...
      <tr>
        ...
        <td id="LC3" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span class="pl-c">#</span> Action script to enable/disable wpa-roam interfaces in reaction to</span></td>
      </tr>
      <tr>
        <td id="L4" class="blob-num js-line-number" data-line-number="4"></td>
        <td id="LC4" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span class="pl-c">#</span> ifplugd events.</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC6" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span class="pl-c">#</span> Copyright: Copyright (c) 2008-2010, Kel Modderman &lt;kel@otaku42.de&gt;</span></td>
      </tr>
      <tr>
        <td id="L7" class="blob-num js-line-number" data-line-number="7"></td>
        <td id="LC7" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span class="pl-c">#</span> License:   GPL-2</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC10" class="blob-code blob-code-inner js-file-line">PATH=/sbin:/usr/sbin:/bin:/usr/bin</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC12" class="blob-code blob-code-inner js-file-line"><span class="pl-k">if</span> [ <span class="pl-k">!</span> <span class="pl-k">-x</span> /sbin/wpa_action ]<span class="pl-k">;</span> <span class="pl-k">then</span></td>
      </tr>
      <tr>
        <td id="L13" class="blob-num js-line-number" data-line-number="13"></td>
        <td id="LC13" class="blob-code blob-code-inner js-file-line">	<span class="pl-c1">exit</span> 0</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC16" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span class="pl-c">#</span> ifplugd(8) - &lt;iface&gt; &lt;action&gt;</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC18" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span class="pl-c">#</span> If an ifplugd managed interface is brought up, disconnect any</span></td>
      </tr>
      <tr>
        <td id="L19" class="blob-num js-line-number" data-line-number="19"></td>
        <td id="LC19" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span class="pl-c">#</span> wpa-roam managed interfaces so that only one &quot;roaming&quot; interface</span></td>
      </tr>
      <tr>
        <td id="L20" class="blob-num js-line-number" data-line-number="20"></td>
        <td id="LC20" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span class="pl-c">#</span> remains active on the system.</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC22" class="blob-code blob-code-inner js-file-line">IFPLUGD_IFACE=<span class="pl-s"><span class="pl-pds">&quot;</span><span class="pl-smi">${1}</span><span class="pl-pds">&quot;</span></span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC24" class="blob-code blob-code-inner js-file-line"><span class="pl-k">case</span> <span class="pl-s"><span class="pl-pds">&quot;</span><span class="pl-smi">${2}</span><span class="pl-pds">&quot;</span></span> <span class="pl-k">in</span></td>
      </tr>
      <tr>
        <td id="L25" class="blob-num js-line-number" data-line-number="25"></td>
        <td id="LC25" class="blob-code blob-code-inner js-file-line">	up)</td>
      </tr>
      <tr>
        <td id="L26" class="blob-num js-line-number" data-line-number="26"></td>
        <td id="LC26" class="blob-code blob-code-inner js-file-line">		COMMAND=disconnect</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC28" class="blob-code blob-code-inner js-file-line">	down)</td>
      </tr>
      <tr>
        <td id="L29" class="blob-num js-line-number" data-line-number="29"></td>
        <td id="LC29" class="blob-code blob-code-inner js-file-line">		COMMAND=reconnect</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC32" class="blob-code blob-code-inner js-file-line">		<span class="pl-c1">echo</span> <span class="pl-s"><span class="pl-pds">&quot;</span><span class="pl-smi">$0</span>: unknown arguments: <span class="pl-smi">${<span class="pl-k">@</span>}</span><span class="pl-pds">&quot;</span></span> <span class="pl-k">&gt;&amp;2</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC37" class="blob-code blob-code-inner js-file-line"><span class="pl-k">for</span> <span class="pl-smi">CTRL</span> <span class="pl-k">in</span> /run/wpa_supplicant/<span class="pl-k">*</span><span class="pl-k">;</span> <span class="pl-k">do</span></td>
      </tr>
      <tr>
        <td id="L38" class="blob-num js-line-number" data-line-number="38"></td>
        <td id="LC38" class="blob-code blob-code-inner js-file-line">	[ <span class="pl-k">-S</span> <span class="pl-s"><span class="pl-pds">&quot;</span><span class="pl-smi">${CTRL}</span><span class="pl-pds">&quot;</span></span> ] <span class="pl-k">||</span> <span class="pl-k">continue</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC40" class="blob-code blob-code-inner js-file-line">	IFACE=<span class="pl-s"><span class="pl-pds">&quot;</span><span class="pl-smi">${CTRL<span class="pl-k">#/</span>run<span class="pl-k">/</span>wpa_supplicant<span class="pl-k">/</span>}</span><span class="pl-pds">&quot;</span></span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC42" class="blob-code blob-code-inner js-file-line">	<span class="pl-c"><span class="pl-c">#</span> skip if ifplugd is managing this interface</span></td>
      </tr>
      <tr>
        <td id="L43" class="blob-num js-line-number" data-line-number="43"></td>
        <td id="LC43" class="blob-code blob-code-inner js-file-line">	<span class="pl-k">if</span> [ <span class="pl-s"><span class="pl-pds">&quot;</span><span class="pl-smi">${IFPLUGD_IFACE}</span><span class="pl-pds">&quot;</span></span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">&quot;</span><span class="pl-smi">${IFACE}</span><span class="pl-pds">&quot;</span></span> ]<span class="pl-k">;</span> <span class="pl-k">then</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC47" class="blob-code blob-code-inner js-file-line">	<span class="pl-k">if</span> wpa_action <span class="pl-s"><span class="pl-pds">&quot;</span><span class="pl-smi">${IFACE}</span><span class="pl-pds">&quot;</span></span> check<span class="pl-k">;</span> <span class="pl-k">then</span></td>
      </tr>
      <tr>
        <td id="L48" class="blob-num js-line-number" data-line-number="48"></td>
        <td id="LC48" class="blob-code blob-code-inner js-file-line">		wpa_cli -i <span class="pl-s"><span class="pl-pds">&quot;</span><span class="pl-smi">${IFACE}</span><span class="pl-pds">&quot;</span></span> <span class="pl-s"><span class="pl-pds">&quot;</span><span class="pl-smi">${COMMAND}</span><span class="pl-pds">&quot;</span></span></td>
      </tr>
      <tr>
  ...
  <details class="details-reset details-overlay BlobToolbar position-absolute js-file-line-actions dropdown d-none" aria-hidden="true">
    ...
    <details-menu>
      <ul class="BlobToolbar-dropdown dropdown-menu dropdown-menu-se mt-2">
        ...
        <li><a class="dropdown-item js-update-url-with-hash" id="js-view-git-blame" role="menuitem" href="/analogdevicesinc/buildroot/blame/fea212afc7dc0ee530762a1921d9ae8180778ffa/board/pluto/wpa_supplicant/action_wpa.sh">View git blame</a></li>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between pt-6 pb-2 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2018 <span title="0.16579s from unicorn-6884bf5549-zgbz6">GitHub</span>, Inc.</li>
